...
Security updates are provided for the latest stable release of `reductstore/web-console` unless stated otherwise in
...
- Use GitHub Security Advisories for this repository:
  https://github.com/reductstore/web-console/security/advisories/new
