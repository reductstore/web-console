...
// (ROW_VALUE_COLUMN_WIDTH) so a row's last input always reaches the same
// right edge as every other row (e.g. the Where condition row, or the
// SQL/Format/Export action column).
