...
describe("ApiUrlParser", () => {
    it("should use location for parsing", () => {
        const location = {pathname: "/ui/buckets", host: "reduct-storage.dev", protocol: "https"} as Location;
    ...
    it("should support prefix api", () => {
        const location = {pathname: "/server1/ui/buckets", host: "reduct-storage.dev", protocol: "https"} as Location;
        const [apiUrl, uiUrl] = parseLocation(location, "/ui");
