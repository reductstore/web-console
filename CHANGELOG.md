...
- Use `*` for the Data Explorer's all-entries pattern, [PR-250](https://github.com/reductstore/web-console/pull/250)

## 1.17.1 - 2026-09-17

### Fixed

- Generate UUIDs when the web console is served over plain HTTP, [PR-249](https://github.com/reductstore/web-console/pull/249)
...
- Add a Transform (ReductSelect) step to the Data Explorer's Conditional Query builder, [PR-246](https://github.com/reductstore/web-console/pull/246)
...
- Fix preview and share link for multi-entry queries, [PR-199](https://github.com/reductstore/web-console/pull/199)
...
- End-to-end tests with Playwright, [PR-192](https://github.com/reductstore/web-console/pull/192)
...
- Pass start/stop time range into JSON query validation requests, [PR-166](https://github.com/reductstore/web-console/pull/166)
